#!/bin/bash
#SBATCH --job-name=noDuplSedNcount   #job name
#SBATCH --mail-type=NONE # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mem-per-cpu=3gb # Per processor memory
#SBATCH --cpus-per-task=1
#SBATCH -t 15:00:00     # Walltime
#SBATCH -o /home/proyectos/bioinfo/fjd/maf_fjd/std/noDuplSedNcount_%j.out # Name output file
#SBATCH -e /home/proyectos/bioinfo/fjd/maf_fjd/std/noDuplSedNcount_%j.err
##SBATCH --file=
##SBATCH --initaldir=
...
/home/proyectos/bioinfo/fjd/maf_fjd/newParser/datamash-1.3/datamash -g1,2 max 98-128 > $projectDir"/"$chr"_NoDupl_Ncount"
