...
def main():
        ...
        for chr in list_of_chrs:
            ...
            for x in range(1,n_project,2):
                ...
                project1_chr_file = list_project[x-1]+"/"+chr+".db.txt_NoDupl_Ncount"
                project2_chr_file = list_project[x]+"/"+chr+".db.txt_NoDupl_Ncount"
                project1_name = list_project[x-1].split("/")[-1].split("_")[0]
                project2_name = list_project[x].split("/")[-1].split("_")[0]

                outputMergeProjects = "/home/proyectos/bioinfo/fjd/maf_fjd/dbs/"+chr+"/"+project1_name+"_"+project2_name+"_e_"+chr+".txt" #con ruta y directorio especfico de chrom"

                print("\nMerging individual chromosomes into database")
                myargs = ["/home/proyectos/bioinfo/fjd/maf_fjd/newParser/merge_projectsChr_Ncount.sh", project1_chr_file, project2_chr_file, outputMergeProjects]
            ...
            if n_project%2.0 != 0:
                ...
                outputMergeProjects = "/home/proyectos/bioinfo/fjd/maf_fjd/dbs/"+chr+"/"+project1_name+"_e_"+chr+".txt"
                shutil.copy(list_project[-1]+"/"+chr+".db.txt_NoDupl_Ncount", outputMergeProjects)
            ...
            while nfiles>1:
                ...
                for x in range(1,nfiles,2):
                    ...
                    outputMergeProjects = "/home/proyectos/bioinfo/fjd/maf_fjd/dbs/"+chr+"/"+project1_name+"_"+project2_name+"_e_"+chr+".txt"
